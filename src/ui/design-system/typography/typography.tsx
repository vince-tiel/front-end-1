...
export const Typography= ({
  variant = "h3", component: Component = "div", theme = "black", weight = "regular", className, children,
}: Props) => {
  ...
  return <>
    <Component className={clsx(variantStyles, colorStyles, weight == "medium" && "font-medium", className)}>{children}</Component>
  </>;
